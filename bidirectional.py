'''
PennApps Twitter Sentiment analysis. First attempt with bidrectional rnn (idk GRU vs LSTM yet). Will do 1D CNN later, which I anticipate to be better
...
val_data = data[int(3*SIZE//4):]
val_label = labels[int(3*SIZE//4):]
